...
<head>
	...
	<style>
	    body {
	        ...
	        min-height: 100vh;
	        background-image: url("images/newindex1.jpeg");
	    ...
	    .namee {
	        ...
	        top: 40px;
	        left: 25px;
	        background-image: linear-gradient(45deg, #FF69B4, #FF1493); /* New vibrant gradient */
	        color: #fff;
	        border: none;
	        padding: 10px 20px;
	        border-radius: 4px;
	    ...
	    .namee:hover {
	        background-image: linear-gradient(45deg, #FF1493, #C71585); /* Hover effect */
	    }
	    ...
	    .form-group button:hover {
	        background-color: #17a58e; /* Darker teal on hover */
	    }
...
<body>
    <header>
        ...
        <h1><b> AIRLINE RESERVATION SYSTEM </b></h1>
