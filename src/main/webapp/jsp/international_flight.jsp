...
<head>
    ...
    <style>
        ...
        /* Attractive Back to Home button styling */
        .button-home {
            display: inline-block;
            padding: 10px 20px;
            text-decoration: none;
        ...
        @media (max-width: 768px) {
            ...
            .back-button input, .book-button, .button-home {
                font-size: 16px;
                padding: 8px 16px;
            }
        }
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td><a class="book-button" href="jsp/international_booking.jsp?flightId=<%= flight.getFlightId() %>&source_city=<%= flight.getSourceCity() %>&destination_city=<%= flight.getDestinationCity() %>&ArrivalTime=<%= flight.getArrivalTime() %>&DepartureTime=<%= flight.getDepartureTime() %>">Book</a></td>
                    </tr>
                <% 
                    }
                %>
